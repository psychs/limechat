...
- (void) readDataToLength:(CFIndex)length withTimeout:(NSTimeInterval)timeout tag:(NSNumber*)tag;
...
- (void) readDataToData:(NSData*)data withTimeout:(NSTimeInterval)timeout tag:(NSNumber*)tag;

/* This reads the first available bytes. */
- (void) readDataWithTimeout:(NSTimeInterval)timeout tag:(NSNumber*)tag;

/* Writes data. If you pass in nil or 0-length data, this method does nothing and the delegate will not be called. */
- (void) writeData:(NSData*)data withTimeout:(NSTimeInterval)timeout tag:(NSNumber*)tag;
